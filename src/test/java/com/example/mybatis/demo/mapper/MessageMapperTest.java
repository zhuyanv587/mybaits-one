...
import com.example.mybatis.demo.model.Message;
...
public class MessageMapperTest {
    ...
    public void testUpdate(){
        Message message = Message.builder().msgId(9).msgText("computer").msgSummary("学校").build();
    ...
    public void testUpdateText(){
        Message message = Message.builder().msgId(10).msgText("computer").msgSummary("").build();
    ...
    public void testSelectById(){
        Message message = messageMapper.selectById(9);
